...
int main(int argc, char** argv) {
    ...
    std::string pipeline = "nvarguscamerasrc sensor-id=0 gainrange=\"2 2\" ! video/x-raw(memory:NVMM), width=1640, height=1232, framerate=30/1, format=NV12 ! nvvidconv flip-method=2 ! video/x-raw, width=1280, height=720, format=NV12 ! videoconvert ! video/x-raw, format=BGR ! appsink";
